...
export default function MobileDesign() {
  ...
  return (
    <div className="flex justify-center items-center flex-col p-1 gap-2">  
      ...
      <Button className="w-full flex items-center justify-center cursor-pointer" onClick={() => signIn("google")}>
        <Image src={'/google-logo.png'} alt="logo" width={20} height={20}></Image>
        Login With Google
      </Button>
      <Button className="w-full flex items-center justify-center cursor-pointer" onClick={() => signIn("github")}>
